...
const translations = {
  ...
  ru: {
    ...
    paragraphs: [
      ...
      "Ключевые принципы работы: системность — применяю структурированные подходы к решению бизнес-задач; эффективность — оптимизирую процессы для достижения максимальной отдачи; командность — выстраиваю рабочие группы, где каждый участник вносит значимый вклад; прозрачность — обеспечиваю открытые коммуникации на всех уровнях взаимодействия; адаптивность — оперативно реагирую на изменения внешней среды и корректирую стратегии.",
      "Моя философия бизнеса основана на балансе трёх ключевых элементов: стратегия — чёткое видение целей и путей их достижения; команда — синергия компетенций и слаженная работа профессионалов; гибкость — способность адаптироваться к новым условиям без потери фокуса.",
      "Стремлюсь к долгосрочному развитию бизнеса, где каждый шаг ведёт к устойчивому росту и созданию ценности.",
    ],
  },
}
